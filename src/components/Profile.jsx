...
const Profile = () => {
  return (
    <div className="flex flex-col gap-2 xxs:w-[320px] xms:w-[w-375px] xs:w-[425px] sm:w-[640px] lg:mx-20">
      {/* header for small screens */}
      <header className="flex md:hidden gap-1 w-full fixed justify-between items-center py-2 px-4 bg-white shadow-sm">
      ...
      <main className="flex md:hidden flex-col w-full h-full xms:items-center xs:justify-normal py-3 grow mt-12 mb-8">
        ...
        <div className="flex xxs:gap-[5px] w-full justify-center sm:justify-start xs:gap-2 px-4">
          <button className="rounded flex justify-center items-center text-sm font-semibold bg-gray-300 py-1 px-6">
            Edit profile
          </button>
          <button className="rounded flex justify-center items-center text-sm font-semibold bg-gray-300 py-1 px-6">
            Share profile
        ...
        <div className="flex w-full flex-col mt-8">
          ...
          <div className="flex w-full flex-wrap gap-[1px] sm:gap-[2px] md:gap-1 mt-[2px]">
            {userProfile.pics.map((pic, i) => (
              <img
                className="
                        xxs:w-[106px] xms:w-[w-375px] xs:w-[141px] sm:w-[212px]
                        xxs:h-[106px] xms:h-[w-375px] xs:h-[141px] sm:h-[212px]
                        "
                src={pic}
                alt="post_pic"
                key={i}
      ...
      <main className="hidden md:flex flex-col gap-2">
        {/* top */}
        <div className="flex gap-5 min-h-44 mt-10 lg:gap-10 justify-center">
          {/* pro pic */}
          ...
          <div className="flex flex-col h-10 gap-4 items-center justify-start">
            <span className="flex items-center">
              ...
              <div className="flex xxs:gap-[5px] w-full justify-center sm:justify-start xs:gap-2 px-3">
                <button className="rounded-lg flex justify-center items-center text-sm font-semibold bg-gray-300 py-2 px-4">
                  Edit profile
                </button>
                <button className="rounded-lg flex justify-center items-center text-sm font-semibold bg-gray-300 py-1 px-4">
                  Share profile
                </button>
        ...
        <div className="w-full border-t-2 mt-5 border-gray-300">
          ...
          <div className="flex h-14 text-sm font-medium gap-10 justify-center">
            <div className=" border-t-2 border-t-slate-900 mt-[-1px] flex items-center justify-center gap-2"> <IoMdGrid className="mt-[2px]" />
              POSTS</div>
            <div className="flex items-center justify-center text-gray-400 gap-2"><MdOutlineWatchLater className="mt-[2px]" />
              SAVED</div>
