...
const AddPost = () => {
  return (
    <div
    className='xxs:w-[320px] xms:w-[375px] xs:w-[450px] max-w-[450px] flex flex-col tracking-tight sticky top-0 h-56 mb-1 px-4 pb-3 pt-2 dark:bg-[#151515] bg-white z-30'
    >
